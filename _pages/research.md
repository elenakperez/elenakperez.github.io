...
## [Marine Heatwaves in the Northwest Atlantic](https://www.nature.com/articles/s41598-021-97012-0) 

* Summer 2020, Summer Student Fellowship project turned into a publication
...
## [Variability of Gulf Stream Warm Core and Cold Core Rings](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2023JC020761)

* 2021–2023, Chapter 1 of thesis
...
* Spring 2023, secondary project for qualifying exams advised by Chris Piecuch
...
## Variability of the Gulf Stream stability and drivers of mean latitudinal shifts 75-70W

* 2024–2025, Chapter 2 of thesis

The Gulf Stream path changes its behavior downstream of Cape Hatteras, North Carolina,
shifting shoreward and seaward coherently between 75°W and 70°W, followed by a contorted
and variable path downstream (east) of 70°W. During the satellite era (1993–2023), the
Gulf Stream path between 75°W and 70°W showed an increasing trend in its position, with
increasing shoreward excursions. We find that this part of the Gulf Stream is strongly
correlated at zero-lag with an anomalous wind stress curl (WSC) pattern over the New
England Seamounts in the eastern Slope and Sargasso seas (r = 0.71). We propose that
Sverdrup dynamics and Rossby wave propagation may explain this strong relationship, such
that the anomalous negative WSC over the New England Seamounts (∼ 65°W) generates
positive sea surface height anomalies that propagate westward via baroclinic Rossby waves.
When these positive SSH anomalies reach the western Slope Sea, they increase the cross-
stream gradient, which causes the steepest area of the SSH gradient to shift shoreward
(northwards). Consequently, the Gulf Stream between 75°W and 70°W to shifts shoreward.
Furthermore, we find that over the same period, the separated Gulf Stream (specifically
downstream of 70°W) has shown variability in its path stability, with some periods displaying
a more stable, straight jet and others an unstable, meandering stream. To quantify the
overall meandering behavior of the Gulf Stream, we define the cumulative Gulf Stream path
variance. We investigate whether the path variance is related to changes in Deep Western
Boundary Current (DWBC) transport or Gulf Stream position, and find no significant,
zero-lag correlations. However, we find that the Gulf Stream path variance lags DWBC
transport by 2.6 years (r = 0.29; p < 0.05), and lags the mean Gulf Stream position between
75°W and 70°W by 5.9 years (r = −0.52; p < 0.05).

<hr>

## Characterization of the Slope Gyre and Slope Jet from satellite and in-situ sub-surface observations

* 2026, Chapter 3 of thesis

[check back in a few months for an update]
